...
export function AmountKeypad({
  ...
  // USDC/EURC have 6 decimals on-chain — an 8-decimal amount can't even be
  // sent — so they cap at 6; cirBTC keeps its full 8.
  const decimalCap = String(token).toUpperCase() === 'CIRBTC' ? 8 : 6
