    ...
    <div className={`relative flex flex-col bg-bg ${isDesktop ? 'h-full' : 'h-screen'}`}>
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-3">
        <AnimatePresence mode="wait">
          ...
          {/* ── FORM ─────────────────────────────────────────────────────── */}
          {step === 'form' && (
            <motion.div key="form" initial={{ opacity: 0, y: MOBILE_TAB_FADE_Y }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }} transition={MOBILE_TAB_FADE_TRANSITION} className="space-y-2.5 pt-1">
