...
export function MultichainClaimPage({ embedded = false, onClose, initialChain, trackClaimId, merchantMode = false }: { embedded?: boolean; onClose?: () => void; initialChain?: string; trackClaimId?: string; merchantMode?: boolean } = {}) {
  ...
  const flow = (
    <div style={{ background: COLORS.bg, display: 'flex', flexDirection: 'column', height: '100%',
