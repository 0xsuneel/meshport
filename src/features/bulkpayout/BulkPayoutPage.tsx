  ...
  return (
    ...
    <div className={`flex flex-col bg-bg ${isDesktop ? 'h-full overflow-visible' : 'h-full overflow-y-auto pb-24'}`}>
      ...
      <AnimatePresence mode="wait">
        ...
        {/* ══════════════════ SETUP STEP ══════════════════ */}
        {step === 'setup' && (
          <motion.div key="setup" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={MOBILE_TAB_FADE_TRANSITION} className="px-4 space-y-4">
            {addRecipientsSection}
            {purposeSection}
            {summarySection}
          </motion.div>
        ...
        {/* ══════════════════ REVIEW STEP ══════════════════ */}
        {step === 'review' && (
          <motion.div key="review" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={MOBILE_TAB_FADE_TRANSITION} className="px-4 space-y-4">
            {reviewContent}
          </motion.div>
        )}
