...
// received from 0x2a31...7976" notification instead of being recognized
// as what it actually was. Added dynamically (imported from
// p2pEscrowContract.ts's own env var) rather than as another hardcoded
// literal, so it can't go stale the way the rest of this list already has
// once before (see the Multicall3 fix note above) on a future redeploy.
if (P2P_ESCROW_CONTRACT_ADDRESS) KNOWN_INTERNAL_CONTRACTS.add(P2P_ESCROW_CONTRACT_ADDRESS)
