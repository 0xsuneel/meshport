 ...
 * TypeScript project... enabling that compiler flag project-wide... was
 * judged riskier than a small, clearly-labeled, disclosed third copy").
 * This directory follows that same established, disclosed-duplication
 * pattern in the other direction: Node source of truth, Deno port for the
 * one live caller that needs it.
 *
 * DO NOT let this drift silently. Any change to classification logic,
 * event types, or the repository contract must be made in server/ledger/
