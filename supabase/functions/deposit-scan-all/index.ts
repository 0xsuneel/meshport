...
function hasVerifiedServiceRole(req: Request): boolean {
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    return json({ success: true, mode, recordedNative: native, recordedTokens: tokens, passCount: 1, passFailures: 0 })
  } catch (e: any) {
